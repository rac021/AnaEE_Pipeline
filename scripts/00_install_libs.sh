...
YEDGEN_CSV_FILES_LOCATION="src/main/resources"
YEDGEN_CSV_DIRECTORY_NAME="csv-files"
...
mv -fv  $ROOT_PATH/$DIRECTORY_LIBS/$TMP/$YEDGEN_CSV_FILES_LOCATION/$YEDGEN_CSV_DIRECTORY_NAME/  \
        $ROOT_PATH/$DIRECTORY_DATA/
