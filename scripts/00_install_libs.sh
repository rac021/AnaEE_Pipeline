...
if [ ! -d "$ROOT_PATH/$DIRECTORY_LIBS/$EXAMPLES" ]; then
mkdir -p $ROOT_PATH/$DIRECTORY_LIBS/$EXAMPLES
fi
...
if [ ! -d "$ROOT_PATH/$DIRECTORY_LIBS/$EXAMPLES/$DIRECTORY_DATA_ONTOP" ]; then
mkdir -p $ROOT_PATH/$DIRECTORY_LIBS/$EXAMPLES/$DIRECTORY_DATA_ONTOP
fi
if [ ! -d "$ROOT_PATH/$DIRECTORY_LIBS/$EXAMPLES/$DIRECTORY_DATA_CORESE" ]; then
mkdir -p $ROOT_PATH/$DIRECTORY_LIBS/$EXAMPLES/$DIRECTORY_DATA_CORESE
fi
if [ ! -d "$ROOT_PATH/$DIRECTORY_LIBS/$EXAMPLES/$DIRECTORY_DATA_YEDGEN" ]; then
