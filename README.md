...
*  **[02_infra_deploy.sh]( https://github.com/rac021/AnaEE_Pipeline/blob/master/scripts/02_infra_deploy.sh)** [ BLZ_IMAGE_NAME  IP-Host-0  IP-Host-1  IP-Host-2  NameSpace ]  SUBNET_NAME SUBNET_RANGE { Optionnal }
